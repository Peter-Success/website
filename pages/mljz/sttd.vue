<template>
  <div class="sttd">
    ...
    <div class="sttd-pc">
      <!--      头图部分-->
      <img class="headImg" src="~/assets/images/sttd/sttd-headImg-pc.jpg" alt="">
      ...
      <ul class="apply">
        ...
        <li class="apply-item title">身体体雕</li>
    ...
    <div class="sttd-h5">
      <!--      头图部分-->
      <img class="headImg" src="~/assets/images/sttd/sttd-headImg-h5.jpg" alt="">
...
import Img1 from '@/assets/images/sttd/sttd-img1.jpg'
import Img2 from '@/assets/images/sttd/sttd-img2.jpg'
import Img3 from '@/assets/images/sttd/sttd-img3.jpg'
import Icon from '~/assets/images/sttd/sttd-icon-more.png'
