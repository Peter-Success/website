<template>
  <div class="jblt">
    ...
    <div class="jblt-pc">
      <!--      头图部分-->
      <img class="headImg" src="~/assets/images/jblt/jblt-headImg-pc.jpg" alt="">
      ...
      <ul class="apply">
        ...
        <li class="apply-item title">面部局部提拉</li>
      </ul>

      <!-- 产品展示部分 -->
      <div class="productBox">
        <div class="productBox-titleBox">
          <div class="productBox-titleBox-title">局部调整</div>
          <span class="productBox-titleBox-subTitle">All</span>
        </div>
    ...
    <div class="jblt-h5">
      <!--      头图部分-->
      <img class="headImg" src="~/assets/images/jblt/jblt-headImg-h5.jpg" alt="">
...
import Img1 from '@/assets/images/jblt/jblt-img1.jpg'
import Img2 from '@/assets/images/jblt/jblt-img2.jpg'
import Img3 from '@/assets/images/jblt/jblt-img3.jpg'
import Icon from '~/assets/images/jblt/jblt-icon-more.png'
