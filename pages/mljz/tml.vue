<template>
  <div class="tml">
    ...
    <div class="tml-pc">
      <!--      头图部分-->
      <img class="headImg" src="~/assets/images/tml/tml-headImg-pc.jpg" alt="">

      <!--      适用人群及项目-->
      <ul class="apply">
        <li class="apply-item">RFAL灵动雕塑</li>
        <li class="apply-item">微整形</li>
        <li class="apply-item title">TML高清脂肪雕塑</li>
    ...
    <div class="tml-h5">
      <!--      头图部分-->
      <img class="headImg" src="~/assets/images/tml/tml-headImg-h5.jpg" alt="">
...
import Img1 from '@/assets/images/tml/tml-img1.jpg'
import Img2 from '@/assets/images/tml/tml-img2.jpg'
import Img3 from '@/assets/images/tml/tml-img3.jpg'
import Icon from '~/assets/images/tml/tml-icon-more.png'
