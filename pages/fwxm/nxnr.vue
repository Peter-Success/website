<template>
  <div class="nxnr">
    ...
    <div class="nxnr-pc">
        ...
        <div class="introduce-contentBox">
          <div class="introduce-contentBox-itemBox">
            ...
            <div class="textBox">
              ...
              <p>医学上将男生胸大的症状称为“男性女乳症（Gynecomastia）是一种非常常见的病症，据流行病学研究显示，3 个男性就有 1 人有此症状，且其中
                60-70%是先天性的，就其组成组织可分为真性、假性及混合性。假性的女乳症主要是由于脂肪增生、堆积原因导致的，而真性的女乳症是乳腺腺体增生或异常发育等原因综合导致的，混合性就是同时存在乳腺及脂肪增生的情况，一般混合性男性女乳症多见。</p>

              <p>“美式微创男性女乳祛除术”是一种既微创无痛、又恢复迅速的治疗方案。这是一种微创、在局部麻醉，仅用针眼伤口、显微器械同时移除乳腺组织、纤维组织和过度堆积的脂肪。</p>
            </div>
          </div>
          ...
          <div class="introduce-contentBox-itemBox">
            ...
            <div class="textBox">
              ...
              <p>New Trend in the Surgical Treatment of Gynecomastia by Tumescent Microliposculpture solely, Chinese
                Journal Of Aesthetic and Plastic Surgery, 2016, 27(4):231-233
              </p>
            </div>
          </div>
        </div>
      ...
      <!--      优势特点-->
      <div class="advantage">
        <div class="advantage-title">技术优势及特色</div>
        ...
        <div class="advantage-textBox">
          ...
          <div class="advantage-textBox-text">
            ...
            <p>
              传统切除手术，是通过开刀的方式直接切除的一种手术，虽然异常增生的乳腺和脂肪组织被切除、让胸部恢复了平坦，但这种手术对身体的创伤却非常大，不仅术中需要全身麻醉，手术创口很大，术后会留下一道长长的疤痕。此外，这一手术的术后恢复也比较复杂，术后需要住院留观，出院后还需要长期护理创口，会很大程度上影响正常的生活节奏，让很多男性朋友望而却步。</p>
      ...
      <div class="notice">
        <div class="notice-textBox">
          ...
          <p>
            1.术后保持伤口清洁干燥，并按照医师指示回诊服药，若伤口有滲血、严重疼痛或身体不适，请联系医生助理。
          </p>
          <p>
            2.伤口术后一周内请勿泡水及游泳，注意保持伤口的干燥清洁，前三天上半身尽量以擦拭为主。
          </p>
          <p>
            3.避免过度活动提重物，以免拉扯或摩擦伤口引起瘀血与伤口愈合速度较慢。
          </p>
          <p>
            4.穿着弹性衣物或胸带，可促进淋巴循环、加速恢复，穿着时间需要以手术医师评估为主。
          </p>
          <p>
            5.多摄取含有蛋白质均衡维生素及营养，同时避免咖啡因、辛辣刺激、海鲜及酒类等刺激性食物。
          </p>
          <p>
    ...
    <div class="nxnr-h5">
      ...
      <!--      特色服务-->
      <div class="serve">
        <div class="serve-title">特色服务</div>
  ...
  data() {
    return {
      questionList: [
        {
          question: 'Q.什么是男性女乳症？',
          answer: '答：男性女乳症(Gynecomastia)并不是疾病，指的是男性胸部的乳腺组织发达，脂肪较肥厚所导致胸部形状明显或激凸问题，并引起男性的社交障碍及自信问题。多数原因是因为体内男性荷尔蒙受到抑制，乳房组织受到女性荷尔蒙的刺激，导致男性乳腺的增大，让原本应该平坦的胸膛有如女性般的胸部隆起，造成胸部突出、下垂甚至存在着发达的乳腺组织，单侧或双侧的胸部都有可能发生。男性女乳症常发生在青春期，属于发育过程的正常现象，会随着时间自然缓解。若是过了青春期还有女乳问题、乳腺异常增生的明显症状，就会建议选择手术彻底治疗。'
        },
        {
          question: 'Q.如何自我检测是否患有男性女乳症？',
          answer: '答：临床的客观标准会是先检视自己的胸部外观大小，用食指与拇指捏起乳晕部分，若是捏起的厚度超过2公分（或厚度大于腋下皮肤），并在乳晕周围摸到圆盘状硬Ｑ、有弹性的乳腺组织，很有可能就是男性女乳症的问题。'
        },
        {
          question: 'Q.男性女乳症可以靠健身运动或减肥瘦身解决吗?',
          answer: '答：没有办法。男性女乳症是因为脂肪堆积及乳腺增生这两个因素所致。运动健身效果是增加肌肉量及强化肌肉线条，乳腺组织也很有可能会因为强健的胸大肌而向外顶出，让激凸问题更加突出。另外，乳腺也不会因为减脂而不见，即使减少胸前外层包覆的脂肪，但也容易因为缺少脂肪包覆，让激凸问题变得明显。'
        },
        {
          question: 'Q.造成男性女乳症的原因有哪些？',
          answer: '答：男性女乳症的成因可以分为生理性及病理性生理性：除了基因遗传所造成之外，男性女乳症较常发生于青春期跟中老年期，主要是因为男性荷尔蒙失衡所导致。而青春期的荷尔蒙变化大约会在6个月至2年内恢复正常，中老年时期会随着年纪增加，男性荷尔蒙减少、女性荷尔蒙增加，而刺激乳腺增大。病理性：因为身体疾病及服用药物所影响，例如甲状腺机能亢进、肝硬化、慢性肾脏衰竭、性染色体异常、肿瘤等病理因素。当体内男性荷尔蒙受到抑制，促进女性荷尔蒙升高，进而导致乳腺的发育，这些原因不应该只以手术切除治疗作为解决，而是就病理问题从根本改善。'
        },
        {
          question: 'Q.哪些因素也可能造成男性女乳症？',
          answer: '答：长期服用激素、抗生素、精神科药物或化疗药物，可能会有抑制男性荷尔蒙分泌，导致刺激乳腺增大，造成男性女乳症。另外，乳腺炎（乳房组织感染）、乳癌（男性仍有1%左右的机率）及脂肪肥厚都是类似于男性女乳症的症状，因此在手术前需要由专业医师评估，以排除上述类似症状。'
        },
        {
          question: 'Q.美式微创男乳祛除术 治疗后注意事项？',
          answer: '答：-术后保持伤口清洁干燥，并按照医师指示回诊服药，若伤口有滲血、严重疼痛或身体不适，请联系医生助理。-伤口术后一周内请勿泡水及游泳，注意保持伤口的干燥清洁，前三天上半身尽量以擦拭为主。-避免过度活动提重物，以免拉扯或摩擦伤口引起瘀血与伤口愈合速度较慢。-穿着弹性衣物或胸带，可促进淋巴循环、加速恢复，穿着时间需要以手术医师评估为主。-多摄取含有蛋白质均衡维生素及营养，同时避免咖啡因、辛辣刺激、海鲜及酒类等刺激性食物。-术后通常会有胸前皮肤可能会有暂时感觉迟钝、麻木等状况，依个人状况需要3-6个月恢复，实际时间因人而异。'
        },
        {
          question: 'Q.男性女乳症会复发吗？',
          answer: '答：已经吸除的乳腺组织、被抽取过的脂肪细胞是不会再增加的，所以医学概率上非常低。但是存留的脂肪细胞仍然有体积变化的可能。假设术后的体重急遽增加，脂肪细胞体积变大，再度囤积在胸部，还是会再发生脂肪型男性女乳症的情形。因此建议术后应该要有体重管理的意识，规律运动、均衡饮食，降低再度复发的机率。'
        }
      ]
    }
  },
...
.nxnr {
  ...
  @at-root &-pc {
    ...
    .serve {
      ...
      background: url("~/assets/images/nxnr/nxnr-fuBgi.png") no-repeat left top/100% 100%;
